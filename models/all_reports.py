...
class AllReportsDashboard(models.AbstractModel):
    _name = 'all.reports.dashboard'
    ...
    def get_dashboard_data(self, date_str):
        ...
        for session in sessions:
            ...
            sessions_data.append({
                ...
                'returns': returns,
                'discount': discount,
                'total': session.amount_total_incl if 'amount_total_incl' in session else sum(orders.mapped('amount_total')),
                'breakdown': breakdown
            })
